...
public class ImportExcel {
     ...
     */
	    public static void exportFromMySQLToExcel(String ip, String port, String database,
	        ...
	        Connection connection = MySQLConnectionUtils.getConnection(ip, port, database, username, password);
	        if(connection == null){
	            log.error("获取数据库连接失败");
	        ...
	        ArrayList<String> excludes = new ArrayList<String>(Arrays.asList(excludeTables));
    ...
    public static void importFromExcelToMySQL(String ip, String port, String database,
        ...
        Connection conn = MySQLConnectionUtils.getConnection(ip, port, database, username, password);
        if(conn == null){
            log.error("连接数据库失败");
        ...
        try{
            ...
            for(int i = 0; i < sheetNum; i++){
                ...
                columnNames.append("privilege,selectedNum ");
                ...
                for(int j = 1; j <= rowNum; j++){
                    ...
                    HSSFCell cell1 = currRow.getCell(1);
                    cell1.setCellType(CellType.STRING);
                    String SQLtest = cell1.getStringCellValue();
                    
                    
                    StudentBean sb1 = null;
                    StudentBeanCl sb = new StudentBeanCl();
                    sb1 = sb.getStuById(SQLtest);
                    ...
                    if(isTableExist(conn, sheetName)){
                        ...
                        try {
                            ...
                            MySQLConnectionUtils.close(statement);
                        }
                    }else{
                	...
                	System.out.println("数据库已存在该学号："+sb1.getId());
                }
                }
            }
        }else {
            ...
            for(int i = 0; i < sheetNum; i++){
                ...
                for(int j = 1; j <= rowNum; j++){
                    ...
                    XSSFCell cell1 = currRow.getCell(1);
                    cell1.setCellType(CellType.STRING);
                    String SQLtest = cell1.getStringCellValue();
    ...
    private static Map<Integer, Map<String, Object>> getAllDataFromTable(String tableName, Connection conn){
        ...
        try {
            res = new LinkedHashMap<Integer, Map<String, Object>>();
