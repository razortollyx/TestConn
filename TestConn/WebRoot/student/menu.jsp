...
<table class="dtree"  style="vertical-align:top"height="800">
	<script type="text/javascript"  style="vertical-align:top"><!--
			...
			*/
			...
			d.add("info_choose", "choose", '选择须知（必看）', 'student/student.jsp?function=attentions');
			...
			d.add("choose_sturesult","choose",'选题结果','student/student.jsp?function=choose_sturesult');
			...
			d.add("use_info", "root", '使用指南');
			d.add("use_info2", "use_info", '选题说明', 'student/student.jsp?function=attentions2');
			d.add("use_info1", "use_info", '使用指南', 'student/student.jsp?function=attentions1');
			document.write(d);
		</script>
