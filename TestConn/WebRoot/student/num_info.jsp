...
<%
	...
	int xuantinum = Integer.parseInt(request.getParameter("xuantinum"));
    String xuantinum1= request.getParameter("xuantinum");
	//if (arrSSTB == null) {
		arrSSTB = new StuSubTeaBeanCl().getAllSSTB(xuantinum1);
