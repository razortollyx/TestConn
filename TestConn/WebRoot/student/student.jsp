...
<table width="100%" border="1" align="left" cellpadding="0"
		...
		<tr>
	      ...
	      <td colspan="2" height="30px" ><div align="center">
					&nbsp;<%=tb.getName()%>学生，欢迎您使用<%=tb.getYuanxi()%>毕业选题系统
		...
		<tr >
			<td colspan="2" height="30px" align="center"><marquee onmouseout=this.start()
					...
					width="80%" height="20px" SCROLLDELAY="90" style="color:#FF6600;"><%=com.kk.subject.model.Tools.getScrollNotice(String.valueOf(tb.getYuanxi())) %></marquee>
			</td> 
		</tr>
...
<table width="60%" height="85" border="0" align="center" style="font-size: 12px" >
      <tr bordercolor="#F0F0F0">
        <td> <div align="center" class="STYLE1">版权所有www.paperlayout.com 鄂ICP备17006782号-1</div></td>
      </tr>
    </table>
