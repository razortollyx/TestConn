...
<form name="form1" method="post">
	<table border="1">
		...
		<tr>
		<td>所属系</td>
			<td align="center"><select name="xibie">
					<%
						for (int k = 0; k < depArr.size(); k++) {
							System.out.println(depArr.get(k).getDepartment());
					%>
					<option value=<%=depArr.get(k).getDepartment()%>><%=depArr.get(k).getDepartment()%></option>
					<%
						}
					%>
			</select></td>
