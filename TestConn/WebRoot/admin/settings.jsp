...
<%
	...
	Settings s = new SettingsCl().getSettings(yuanxi);
...
<form action="SettingsServlet?flag=warnNum" method="post">
	<table width="50%" height="255" border="1" cellpadding="0"
		...
		<input type="hidden" border="0" id="q1"  value=<%=yuanxi%> readonly="true"/>
...
<form action="SettingsServlet?flag=maxSelNum" method="post">
	...
	<input type="hidden" border="0" id="q2"  value=<%=yuanxi%> readonly="true"/>
</form>
<!-- 老师最多出几道题 -->
<form action="SettingsServlet?flag=maxNum" method="post">
	<table width="50%" height="255" border="1" cellpadding="0"
		cellspacing="0">
		<tr>
			<th colspan="2" scope="col"><div align="left">老师出题上限</div></th>
		</tr>
		<tr align="center">
			<td width="65%"><div align="center">老师出题上限</div></td>
			<td width="35%"><%=s.getMaxnum()%></td>
		</tr>
		<tr align="center">
			<td><div>设置老师出题上限</div></td>
			<td><input style="width: 100%;  border=0; align=center;"
				name="maxNum" /></td>
		</tr>
		<tr>
...
<form action="SettingsServlet?flag=add_direc" method="post">
	<table width="50%" border="1" cellpadding="0" cellspacing="0">
		...
		<%
			ArrayList al = new DirectionCl().getAllDirec(yuanxi);
		...
		<input type="hidden" border="0" id="q3"  value=<%=yuanxi%> readonly="true"/>
</form>
<!-- 添加删除 系名 -->
<form action="SettingsServlet?flag=add_dep" method="post">
	<table width="50%" border="1" cellpadding="0" cellspacing="0">
		...
		<input type="hidden" border="0" id="q4"  value=<%=yuanxi%> readonly="true"/>
</form>
	...
	<table width="50%" border="1" cellpadding="0" cellspacing="0">
		...
		<%
			...
			for (int i = 0; i < jtArr.length; i++) {
				int r = new JobTitleBeanCl().getJTid(yuanxi,jtArr[i]);	
		%>
		<tr>
			...
			<td><div align="center">
					<a onclick="return delJtConf();"
						href="SettingsServlet?flag=del_jobTitle&jobTitle=<%=r%>">删除</a>
				</div></td>
		</tr>
		<%
			}
		...
		<input type="hidden" border="0" id="q5"  value=<%=yuanxi%> readonly="true"/>
</form>
...
<form action="SettingsServlet?flag=graduateGrade" method="post">
	<table width="50%" height="255" border="1" cellpadding="0"
		...
		<tr align="center">
			<td><input type="hidden" border="0" id="q6"  value=<%=yuanxi%> readonly="true"/></td>
		</tr>
		<tr>
