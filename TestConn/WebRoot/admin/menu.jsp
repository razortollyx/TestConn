...
<table class="dtree"  style="vertical-align:top">
	<script type="text/javascript"  style="vertical-align:top">
			...
			*/
			...
			d.add("stage", "setup", '选题阶段', 'admin/admin.jsp?function=stage');
			d.add("attentions", "setup", '注意事项(必读)', 'admin/admin.jsp?function=attentions');			
			...
			d.add("tea_manage", "root", '教师管理');
			d.add("tea_all", "tea_manage", '教师信息', 'admin/admin.jsp?function=tea_all');
			d.add("tea_add", "tea_manage", '添加教师账号', 'admin/admin.jsp?function=tea_add');
