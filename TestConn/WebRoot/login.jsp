							...
							<form action="LoginClServlet" method="post">
								...
								<table width="85%" border="0" align="left" cellspacing="3">
									...
									<tr>
										...
										<%-- <td class="STYLE3"><a href="Found.jsp">忘记密码？</a><font color="red"><%=err%></td> --%>
									</tr>
																		<tr>
										<td class="FontWit">
										...
										<TBODY>
											<TR>
												<TD>
													<DIV align="center" class="FontWit">
														<p>
															武汉锐智图文www.paperlayout.com 鄂ICP备17006782号-1 <A href="Found.jsp" target="_blank"
																class="STYLE3"></A> &nbsp;<a
																href="tencent://message/?uin="><img
