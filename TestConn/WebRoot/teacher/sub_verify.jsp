...
<script type="text/javascript">
	function screening() {
		document.form1.action = "SubManageServlet?flag=screeningSub1";
		document.form1.submit();
	}
	//批量通过审核
	function batchVerifySub() {
		document.form1.action = "SubManageServlet?flag=batch_verify_sub1";
		document.form1.submit();
	}
	//批量审核不通过
	function batchNotPass() {
		document.form1.action = "SubManageServlet?flag=batch_not_pass1";
		document.form1.submit();
	}
...
<%
	...
	String xibie=tb.getXibie();
	String viewType = (String) hs.getAttribute("viewType");
	if (viewType == null)
		viewType = "0";
	/* ArrayList<SubjectBean> al = new SubjectBeanCl().getSubByState(viewType); */
	ArrayList<SubjectBean> al = new SubjectBeanCl().getSubByState3(viewType,tbDepa,xibie);
